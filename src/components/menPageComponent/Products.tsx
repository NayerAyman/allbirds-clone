...
// DATA
// =====================
const menShoes:Product[] = [
  {
    id: "mens-canvas-piper",
...

  {
    ...
    sizes: [39, 40, 41, 42, 43, 44, 45, 46],
    colors: [
      { colorName: "creem", hex: "#eeebcb", price: 105, salePrice: null, images: "/shoes/men/Men's Tree Runner/TR2MWHE_SHOE_LEFT_GLOBAL_MENS_TREE_RUNNER_WHEAT_DARK_BEIGE.webp" },
      { colorName: "black", hex: "#000000", price: 105, salePrice: null, images: "/shoes/men/Men's Tree Runner/TR3MJBK080_SHOE_LEFT_GLOBAL_MENS_TREE_RUNNER_JET_BLACK_BLACK.webp" },
      { colorName: "black & white", hex: "#444444", price: 105, salePrice: null, images: "/shoes/men/Men's Tree Runner/TR3MJBW080_SHOE_LEFT_GLOBAL_MENS_TREE_RUNNER_JET_BLACK_WHITE.webp" },
      { colorName: "white", hex: "#f5f5f5", price: 105, salePrice: null, images: "/shoes/men/Men's Tree Runner/TR3MKWW_SHOE_LEFT_GLOBAL_MENS_TREE_RUNNER_KAIKOURA_WHITE_WHITE_f54746ea-c9a5-45dc-907c-90ddc0ae6ecf.webp" },
    ],
  },

  {
    id: "mens-wool-cruiser-slip-on",
  ...
  {
    id: "mens-wool-cruiser-waterproof",
  ...
  {
    id: "mens-wool-runner-nz",
    name: "Men's Wool Runner NZ",
    sizes: [39, 40, 41, 42, 43, 44, 45, 46],
    colors: [
      { colorName: "black ", hex: "#141414", price: 135, salePrice: null, images: "/shoes/men/Men's Wool Runner NZ/A12005_25Q3_Wool-Runner-NZ-Dark-Jungle-Stony-Cream-Sole_PDP_LEFT.webp" },
      { colorName: "blue", hex: "#0b1a31", price: 135, salePrice: null, images: "/shoes/men/Men's Wool Runner NZ/A12011_25Q3_Wool_Runner_NZ_Dark_Navy_Blizzard_Sole_PDP_LEFT.webp" },
      { colorName: "dark - gray", hex: "#4c4c4c", price: 135, salePrice: null, images: "/shoes/men/Men's Wool Runner NZ/A12012_25Q3_Wool-Runner-NZ-Dark-Grey-Light-Grey-Sole_PDP_LEFT__1.webp" },
      { colorName: "gray", hex: "#aeaeae", price: 135, salePrice: null, images: "/shoes/men/Men's Wool Runner NZ/A12017_25Q3_Wool_Runner_NZ_Medium_Grey_Blizzard_Sole_PDP_LEFT.webp" },
    ],
  },

  {
    id: "mens-wool-runner-nz-mid-waterproof",
...
const womenShoes: Product[] = [
  {
    id: "womens-allbirds-sliper",
...
export default function Products({ category }: ProductsProps) {
  const shoes = category === "Men" ? menShoes : womenShoes;

  return (
    <div className="w-full md:w-[93%] h-dvh grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-5 p-4">
      {shoes.map((product) => (
        ...
        <p className="font-semibold text-red-600 text-sm mt-1">
          {activeColor.salePrice ? (
            <>
              ...
              <span className="text-gray-600">${activeColor.salePrice}</span>
            </>
          ) : (
            <>${activeColor.price}</>
          )}
